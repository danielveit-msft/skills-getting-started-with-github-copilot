...
# Dependency-injected in-memory activity database
...
@app.get("/activities")
def get_activities(activities=Depends(get_activities_store)):
    return activities


@app.post("/activities/{activity_name}/signup")
def signup_for_activity(activity_name: str, email: str, activities=Depends(get_activities_store)):
...
def unregister_from_activity(activity_name: str, email: str, activities=Depends(get_activities_store)):
